...
function Privacy() {
  ...
  useEffect(() => {
    ...
    const userIsAuthenticated = false; // Change this based on your logic
  ...
  const handleLogout = () => {
    ...
    // Add your real logout logic if necessary
  };
  return (
    <>
      <HelmetProvider>
        <Helmet>
          ...
          <meta
            name="description"
            content="Consultez notre politique de confidentialité pour savoir comment nous collectons, utilisons et protégeons vos données personnelles sur UniverDog."
          />
          <meta
            property="og:title"
            content="Politique de Confidentialité - UniverDog"
          />
          <meta
            property="og:description"
            content="Découvrez comment UniverDog protège vos données personnelles conformément aux lois en vigueur."
          />
          ...
          <div className="privacy-container">
            ...
            <ul className="privacy-list">
              ...
              <li className="privacy-list-item">
                ...
                pour nous aider à utiliser vos informations, comme décrit
                ci-dessus. Par exemple, nous utilisons Shopify pour alimenter
              ...
              <li className="privacy-list-item">
                ...
                abusif, ainsi que contre l&#39;accès non autorisé, la
                divulgation, l&#39;altealtération et la destruction.
                <br />
                <br />
              </li>
              <li className="privacy-list-item">
              ...
              <li className="privacy-list-item">
                ...
                temps à autre afin de refléter, par exemple, des changements
                dans nos pratiques ou pour d&#39;autres raisons opérationnelles,
              ...
              <li className="privacy-list-item">
                ...
                <br />
                Pour plus d&#39;informations sur nos pratiques de
                confidentialité, si vous avez des questions, ou si vous
                souhaitez faire une plainte, veuillez nous contacter par e-mail
                à <a href="mailto:contact@univerdog.fr">contact@univerdog.fr</a>
                .
                <br />
                <br />
                <br />
