  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>
            Charte de Protection des Données Personnelles - UniverDog
          </title>
          <meta
            name="description"
            content="Découvrez comment UniverDog protège vos données personnelles conformément à la législation en vigueur."
          />
          <meta
            property="og:title"
            content="Charte de Protection des Données Personnelles - UniverDog"
          />
          <meta
            property="og:description"
            content="Informations sur la protection des données et le respect de la vie privée chez UniverDog."
          />
      ...
      >
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-4">
            Charte de Protection des Données Personnelles (CGPV)
          </h1>

          <h2 className="text-2xl font-bold mb-4">Préambule</h2>
          <h4 className="text-lg font-bold mb-2 text-red-600">
            Un site web démo dans le cadre d&#39;un projet de fin de formation
          </h4>
          ...
          <p className="mb-4">
            ...
            utilisateurs. La présente Charte de Protection des Données
            Personnelles (CGPV) a pour objet de vous informer sur la manière
            dont nous collectons, traitons et protégeons vos données
          ...
          <p className="mb-4">
            Les données personnelles que nous collectons peuvent inclure, mais
          ...
          <ul className="list-disc ml-6">
            ...
            <li className="mb-2">
              <strong>Données relatives à votre animal:</strong> Nom de
              l&apos;animal, race, âge, sexe, poids, photo, suivi de santé,
              allergies, médicaments, activité physique, comportement.
            </li>
            <li className="mb-2">
              <strong>Données de navigation:</strong> Adresse IP, type de
              navigateur, système d&apos;exploitation, pages visitées, actions
          ...
          <ul className="list-disc ml-6">
            <li className="mb-2">
              <strong>Fournir et améliorer nos services:</strong> Gérer les
              comptes utilisateurs, personnaliser l&apos;expérience utilisateur,
              fournir des services adaptés à vos besoins.
            </li>
            <li className="mb-2">
              <strong>Communiquer avec vous:</strong> Répondre à vos demandes,
              vous envoyer des informations sur nos services, des newsletters,
              des promotions.
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
              <strong>Améliorer notre site web et nos services:</strong>{" "}
              Analyser les données de navigation pour améliorer l&apos;ergonomie
              et la performance de notre site, identifier les tendances et les
          ...
          <ul className="list-disc ml-6">
            <li className="mb-2">
              <strong>Consentement:</strong> Vous nous avez donné votre
              consentement explicite pour le traitement de vos données
              personnelles.
            </li>
            <li className="mb-2">
              <strong>Exécution du contrat:</strong> Le traitement de vos
              données est nécessaire à l&apos;exécution d&apos;un contrat auquel
              vous êtes partie.
            </li>
            <li className="mb-2">
              <strong>Intérêt légitime:</strong> Le traitement de vos données
              est nécessaire pour nos intérêts légitimes, tels que
              l&apos;amélioration de nos services et la communication avec nos
              utilisateurs.
            </li>
          </ul>
          ...
          <p className="mb-4">
            ...
            confidentialité de vos données personnelles et les protéger contre
          ...
          <ul className="list-disc ml-6">
            <li className="mb-2">
              ...
              hébergeurs de données, des fournisseurs de services de paiement,
              des agences de marketing.
            </li>
            <li className="mb-2">
              <strong>Obligations légales:</strong> Nous pouvons être tenus de
              partager vos données personnelles avec des autorités compétentes
              si la loi l&apos;exige.
            </li>
            <li className="mb-2">
              <strong>Fusion ou acquisition:</strong> En cas de fusion,
              d&apos;acquisition ou de vente de notre entreprise, vos données
              personnelles peuvent être transférées au nouvel acquéreur.
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6">
            <li className="mb-2">
              <strong>Droit d&apos;accès:</strong> Vous avez le droit
              d&apos;accéder à vos données personnelles et de demander une copie
              de celles-ci.
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
              ...
              Vous avez le droit de demander l&apos;effacement de vos données
            ...
            <li className="mb-2">
              <strong>Droit à la portabilité des données:</strong> Vous avez le
              droit de recevoir vos données personnelles dans un format
              structuré, couramment utilisé et lisible par machine.
            </li>
            <li className="mb-2">
              <strong>Droit d&apos;opposition:</strong> Vous avez le droit de
              vous opposer au traitement de vos données personnelles, notamment
              au profilage.
            </li>
          </ul>
