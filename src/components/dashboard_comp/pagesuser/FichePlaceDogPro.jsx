  ...
  useEffect(() => {
    const fetchPlace = async () => {
      try {
        ...
        setComments(
          commentsResponseComment.data.filter(
            (comment) => comment.place_id === parseInt(id)
          )
        );
        /////////////////////////////////////////////////////

        // Merge comments and userscomments
...
FichePlaceDogPro.propTypes = {
  tarifs: PropTypes.number,
};

export default FichePlaceDogPro;
