...
const Signalement = () => {
  ...
  return (
    <div
      id="signalements"
      className="dark:bg-zinc-400 text-xs mt-8 bg-white rounded-lg shadow-md animate-slideIn  mb-8   md:p-9"
    >
      {notification && (
        <Notification type={notification.type} message={notification.message} />
      )}
      <h1 className="text-xl font-bold mb-6 mt-4 dark:text-gray-800 pl-8">
        Gestion des signalements
      </h1>

      
        <table className="divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-700">
