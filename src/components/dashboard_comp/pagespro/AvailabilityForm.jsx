...
function AvailabilityForm({
  ...
  const handleSubmit = (e) => {
    ...
    const newStartTime = `${startHour.padStart(2, "0")}:${startMinute.padStart(
      2,
      "0"
    )}`;
    const newEndTime = `${endHour.padStart(2, "0")}:${endMinute.padStart(
      2,
      "0"
    )}`;
    availability.start_time = newStartTime;
    availability.end_time = newEndTime;
    //("Submitting availability:", availability); // Debugging log
