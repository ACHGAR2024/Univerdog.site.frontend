...
function AvailabilityList({ availabilities, setSelectedAvailability, deleteAvailability }) {
  return (
          ...
          <tbody>
            {availabilities.map(availability => (
              <tr key={availability.id}>
                ...
                <td className="p-2 border-b">{availability.start_time < '12:00:00' ? periode[0] : periode[1]}</td>
